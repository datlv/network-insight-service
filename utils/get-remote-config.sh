...
# To run: ./get-remote-config.sh -d ~/Working/Deevo/network-insight-service/configs -t /tmp/test-net -p 54.169.140.0 -k ~/Working/Deevo/pem/dev-full-rights.pem -g "org0 org1 org2 org3 org4 org5"
